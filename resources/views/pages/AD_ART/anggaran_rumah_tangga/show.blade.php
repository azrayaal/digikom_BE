        ...
        <div class="card" style="background-color: #2A2A2A; border-radius: 10px;">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <h5 class="text-muted fw-bold">Detail anggaran_rumah_tangga</h5>
                        <p class="text-white"><strong>Bulan:</strong> {{ $anggaran_rumah_tangga->bulan }}</p>
                        <p class="text-white"><strong>Jumlah:</strong> {{ $anggaran_rumah_tangga->jumlah }}</p>
                        <p class="text-white"><strong>Keterangan:</strong> {{ $anggaran_rumah_tangga->keterangan }}</p>
                    </div>
                    <!-- Deskripsi -->
                    <!-- <div class="col-md-8">
                        <h5 class="text-muted fw-bold">Deskripsi</h5>
                        <div class="text-white">
                            {!! $anggaran_rumah_tangga->deskripsi_anggaran_rumah_tangga !!}
                        </div>
                    </div> -->
                </div>
            </div>
