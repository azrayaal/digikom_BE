...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    ...
    <ul class="nav">
        ...
        <!-- Iuran -->
        <li class="nav-item menu-items">
            <a class="nav-link {{ request()->is('iuran*') || request()->is('tagihan*') || request()->is('laporan-iuran*') ? 'active' : '' }}" data-toggle="collapse" href="#iuran" aria-expanded="false" aria-controls="iuran">
                <span class="menu-icon">
