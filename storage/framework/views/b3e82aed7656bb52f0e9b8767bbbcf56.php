...
<html lang="en">
  <head>
    ...
    <!-- plugins:css -->
    <link rel="stylesheet" href="/corona/dist/assets/vendors/mdi/css/materialdesignicons.min.css">
    <link rel="stylesheet" href="/corona/dist/assets/vendors/ti-icons/css/themify-icons.css">
    <link rel="stylesheet" href="/corona/dist/assets/vendors/css/vendor.bundle.base.css">
    <link rel="stylesheet" href="/corona/dist/assets/vendors/font-awesome/css/font-awesome.min.css">
    <!-- endinject -->
    ...
    <!-- endinject -->
    <!-- Layout styles -->
    <link rel="stylesheet" href="/corona/dist/assets/css/style.css">
    <!-- End layout styles -->
    <link rel="shortcut icon" href="/assets/yong.png" />
  </head>
  <body>
          ...
          <div class="content-wrapper full-page-wrapper d-flex align-items-center auth login-bg">
            <div class="card col-lg-4 mx-auto">
              <div class="card-body px-5 py-5">
                ...
                <p>This privacy notice for <strong>__________</strong> ("we," "us," or "our"), describes how and why we might collect, store, use, and/or share ("process") your information when you use our services ("Services"), such as when you:</p>
                <ul>
                    <li>Visit our website, or any website of ours that links to this privacy notice</li>
                    <li>Download and use our mobile application (IndoJual), or any other application of ours that links to this privacy notice</li>
                ...
                <p>We collect personal information that you voluntarily provide to us when you register on the Services, express an interest in obtaining information about us or our products and Services, or participate in activities on the Services.</p>
                <ul>
                    <li>names</li>
                    <li>phone numbers</li>
                ...
                <ul>
                    ...
                    <li><strong>Offer Wall:</strong> Displaying third-party hosted "offer wall" for virtual currency, gifts, or other items.</li>
                </ul>
                ...
                <p>Most web browsers and some mobile operating systems and applications include a Do-Not-Track ("DNT") feature or setting you can activate to signal your privacy preference.</p>
                ...
                <p>__________<br>__________<br>__________</p>
                
                <h2>10. How Can You Review, Update, or Delete the Data We Collect from You?</h2>
                <p>Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you.</p>
    ...
    <!-- container-scroller -->
    <!-- plugins:js -->
    <script src="/corona/dist/assets/vendors/js/vendor.bundle.base.js"></script>
    <!-- endinject -->
    <!-- Plugin js for this page -->
    <!-- End plugin js for this page -->
    <!-- inject:js -->
    <script src="/corona/dist/assets/js/off-canvas.js"></script>
    <script src="/corona/dist/assets/js/misc.js"></script>
    <script src="/corona/dist/assets/js/settings.js"></script>
    <script src="/corona/dist/assets/js/todolist.js"></script>
    <!-- endinject -->
  </body>
</html>
...
<script src="/corona/dist/assets/vendors/js/vendor.bundle.base.js"></script>
<script src="/corona/dist/assets/js/off-canvas.js"></script>
<script src="/corona/dist/assets/js/misc.js"></script><?php /**PATH /home/azrayaal/Downloads/digikom/be/resources/views/pages/privacy/privacy.blade.php ENDPATH**/ ?>