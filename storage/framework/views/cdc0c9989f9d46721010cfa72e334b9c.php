                            ...
                            <tbody>
                                <?php $__currentLoopData = $iuran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr onclick="location.href='<?php echo e(route('iuran.show', $item->id)); ?>'" style="cursor: pointer;">
                                        ...
                                        <td><?php echo e($item->iuran->tahun); ?></td> <!-- Akses tahun dari relasi iuran -->
                                        <td><?php echo e($item->status); ?></td>
                                        <td>
                                            <a href="<?php echo e(route('iuran.edit', $item->id)); ?>" class="btn btn-sm btn-warning">Detail</a>
                                        </td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
...
</div><?php /**PATH /home/azrayaal/Desktop/codes/digikom/be/resources/views/pages/iuran/laporan.blade.php ENDPATH**/ ?>