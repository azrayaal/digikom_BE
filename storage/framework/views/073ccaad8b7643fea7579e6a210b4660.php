...
<div class="main-panel">
    <div class="content-wrapper" style="background-color: #D1D1D1;">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <a href="<?php echo e(route('anggota.create')); ?>" class="btn btn-primary">Add New Anggota</a>
        </div>
                ...
                <table class="table table-hover text-white">
                    ...
                    <tbody>
                        ...
                        <tr onclick="location.href='<?php echo e(route('anggota.show', $item->id)); ?>'" style="cursor: pointer;">
                            ...
                            <td>
                                <img src="<?php echo e(asset('storage/' . $item->profile_picture)); ?>" alt="">
                            </td>
                            ...
                            <td>
                                <a href="<?php echo e(route('anggota.edit', $item->id)); ?>" class="btn btn-sm btn-primary">Edit</a>
                                <a href="<?php echo e(route('anggota.edit', $item->id)); ?>" class="btn btn-sm btn-warning">Suspend</a>
...
<?php /**PATH /home/azrayaal/Desktop/codes/digikom/be/resources/views/pages/user/index.blade.php ENDPATH**/ ?>