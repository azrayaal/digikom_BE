...
<div class="main-panel">
    <div class="content-wrapper" style="background-color: #D1D1D1;">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <a href="<?php echo e(route('pengurus.create')); ?>" class="btn btn-primary">Create New pengurus</a>
        </div>
        <div class="col grid-margin stretch-card">
            <div class="card" style="background-color: #2A2A2A;">
                ...
                <div class="mb-4">
                    ...
                    <form action="<?php echo e(route('pengurus.index')); ?>" method="GET" class="">
                    ...
                    <form action="<?php echo e(route('pengurus.index')); ?>" method="GET" class="d-flex align-items-center">
                        <input type="text" name="search" class="form-control" placeholder="Cari pengurus..." value="<?php echo e(request('search')); ?>" onfocus="this.style.backgroundColor='#2A3038'; this.style.color='#ffffff';">
                ...
                <table class="table table-hover text-white">
                    ...
                    <tbody>
                        ...
                        <tr onclick="location.href='<?php echo e(route('pengurus.show', $item->id)); ?>'" style="cursor: pointer;">
                            <td><?php echo e($loop->iteration); ?></td>
                            <td><?php echo e($item->user->full_name); ?></td>
                            <td><?php echo e($item->jabatan->nama_jabatan); ?></td>
                            <td>
                                <a href="<?php echo e(route('pengurus.edit', $item->id)); ?>" class="btn btn-sm btn-warning">Edit</a>
                                <form action="<?php echo e(route('pengurus.destroy', $item->id)); ?>" method="POST" style="display: inline-block;">
                                    <?php echo csrf_field(); ?>
        ...
        <div class="d-flex justify-content-center mt-4">
            <?php echo e($pengurus->links('pagination::bootstrap-4')); ?>
...
<?php /**PATH /home/azrayaal/Downloads/digikom/be/resources/views/pages/pengurus/index.blade.php ENDPATH**/ ?>